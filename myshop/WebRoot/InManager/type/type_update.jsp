...
<%
	String tid=request.getParameter("tid");
  	...
  	Type t=ShopManager.getTypeById(tid);

 %>
  <body>
  <form action="app/intype_update" method="post">
	...
	<tr><input type="hidden" name="t.tid" value="<%=t.getTid()%>">
		<th width="30%"  scope="row">类型名称：</th>
		<td width="70%"><input type="text" name="t.tname" value="<%=t.getTname() %>" style="width: 100%"></td>
	</tr>
	<tr>
		<th scope="row">类型描述：</th>
		<td><input type="text" value="<%=t.getTdescip() %>" name="t.tdescip" style="width: 100%">
		</td>
