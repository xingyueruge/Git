...
border:1px solid #90BCFF;
  ...
  <body style="font-size: 10px ; background-color: #A1CAF9" >
    ...
    <%
    	List<Commodity> al=ShopManager.listCommodity();
    ...
    <tr>
    	...
    	<td><img style="height: 50;width: 70" src="<%=al.get(i).getCpicture()%>"></img> </td>
